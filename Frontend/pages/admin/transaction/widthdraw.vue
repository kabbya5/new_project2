<template>
  <div class="pb-6 pt-1 w-full" style="width: 100%;">
    <div class="w-full bg-white dark:bg-gray-900 rounded-2xl shadow-lg overflow-hidden">
      <!-- Header -->
        ...
        <div v-else class="overflow-x-auto w-full">
            <table class="min-w-full text-sm text-gray-700 dark:text-gray-200 border-collapse">
                <thead class="bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300 uppercase text-xs font-semibold">
                <tr>
                    <th class="text-left px-4 sm:px-6 py-3 whitespace-nowrap min-w-[100px]">Order #</th>
                    <th class="text-center px-4 sm:px-6 py-3 whitespace-nowrap min-w-[100px]">User</th>
                    <th class="text-center px-4 sm:px-6 py-3 whitespace-nowrap min-w-[100px]">Type</th>
                    <th class="text-center px-4 sm:px-6 py-3 whitespace-nowrap min-w-[100px]">Created At</th>
                    <th class="text-right px-4 sm:px-6 py-3 whitespace-nowrap min-w-[100px]">Amount</th>
                    <th class="text-center px-4 sm:px-6 py-3 whitespace-nowrap min-w-[100px]">Status</th>
                    <th class="text-center px-4 sm:px-6 py-3 whitespace-nowrap min-w-[100px]">Provider</th>
                    <th class="text-left px-4 sm:px-6 py-3 whitespace-nowrap min-w-[100px]">Remark</th>
                </tr>
                </thead>
                ...
                >
                    <td class="px-4 sm:px-6 py-3 font-medium text-gray-800 dark:text-gray-100 whitespace-nowrap">
                    ...
                    <td class="text-center px-4 sm:px-6 py-3 whitespace-nowrap">
                    <span
                    ...
                    <td class="text-right px-4 sm:px-6 py-3 whitespace-nowrap">
                    {{ transaction.amount.toLocaleString() }}
                    <span class="uppercase"> {{ authStore.user?.currency }}</span>
                    </td>
                    ...
                    <td class="text-left px-4 sm:px-6 py-3 whitespace-nowrap">
                    {{ transaction.remark || '-' }}
                    </td>
                </tr>
                </tbody>
            ...
            <Pagination v-model="currentPage" :total-pages="totalPages" class="mt-4" />
        </div>
    </div>
  </div>
</template>
