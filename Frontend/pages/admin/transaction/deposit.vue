<template>
  ...
  <div class="container mx-auto pb-6 pt-1 px-3">
          ...
          <tbody>
            ...
            >
              ...
              <td class="px-6 py-2  text-right text-sm font-medium">
                  ...
                  <button v-if="transaction.status!=='success' && !transaction.agent_id" @click="approval(transaction.id)" class="ml-2">
                      <i class="fa-solid fa-check"></i>
                  </button>

                  <button v-if="transaction.canDelete && transaction.status == 'pending'" @click="deleteTransaction(transaction.id)" class="ml-2">
