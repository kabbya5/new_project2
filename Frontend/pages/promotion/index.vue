        ...
        <section class="container mx-auto p-4">
            ...
            <div class="grid grid-cols-12 gap-4 mt-6">
                <div v-for="promotion in promotions" class="col-span-12 md:col-span-6 lg:col-span-4">
                    <div class="bg-card text-white rounded-2xl shadow-md hover:shadow-xl transition duration-300 overflow-hidden">
                        ...
                        <div class="p-2 mb-2">
                            <NuxtLink
                                ...
                                class="inline-block bg font-semibold px-4 py-2 rounded-lg hover:bg-gray-200 transition"
                            >
                                Show More
                            </NuxtLink>
                        </div>
