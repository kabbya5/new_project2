<template>
    <div v-if="sidebar.isOpen" class="h-full side-menu" id="admin-sidebar">
        <!-- Sidebar -->
        <aside>
            <!-- Logo  -->
            ...
            <nav class="space-y-1 px-3 py-2">
                <NuxtLink to="/affiliate/dashboard" class="sidebar-link">
  ...
  const navLinks = computed(() => [
    {
      ...
      url:'/affiliate/transaction/deposit',
    },

    {
      ...
      url:'/affiliate/transaction/withdraw',
    },
    {
      name:'transaction',
      title:'Transaction',
      icon:'fa-solid fa-wallet',
      url:'/affiliate/transaction',
    },
    {
      name:'User',
      title:'User',
